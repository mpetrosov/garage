...
<div class="row own-color">
  ...
  <div class="col-4">
      {{-- <h4>Calandstraat 89, Schideam</h4>
      <h5>010-7518506</h5>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption own-caption">
                            ...
                            <h6 class="animated fadeInUp" style="animation-delay: 2s">Nulla vitae elit libero, a pharetra augue mollis interdum.</h6>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="{{URL::asset('/img/schadeherstel.jpg')}}" class="rounded" alt="profile Pic" height="300" width="500">
                        <div class="carousel-caption own-caption">
                            <h5 class="animated fadeInLeft" style="animation-delay: 1s">Second slide label</h5>
                            <h6 class="animated fadeInRight" style="animation-delay: 2s"> Nulla vitae elit libero, a pharetra augue mollis interdum.</h6>
                        </div>
                    </div>
                    <div class="carousel-item">
...
@section('gridboven')
    ...
    <div class="row text-center">
        <div class="col-md-3 shadow rounded client inner p-0">
            <img src="{{URL::asset('/img/motor.jpg')}}" class="p-0" alt="profile Pic" height="200" width="367">
        ...
        <div class="col shadow rounded client ml-2 inner p-0">
            <img src="{{URL::asset('/img/Turbo.jpg')}}" class="rounded" alt="profile Pic" height="200" width="367">
            <div class="carousel-caption"><h2>Turbo Revisie en Reparatie</h2></div>
        </div>
        <div class="col shadow rounded client ml-2 inner p-0">
            <img src="{{URL::asset('/img/computer diagnostic.jpg')}}" class="rounded" alt="profile Pic" height="200" width="367">
            <div class="carousel-caption"><h2> Uitlezen van Foutcodes</h2></div>
        </div>
        <div class="col-md-3 shadow rounded client ml-2 inner p-0">
            <img src="{{URL::asset('/img/schadeherstel.jpg')}}" class="rounded" alt="profile Pic" height="200" width="367">
...
@section('gridonder')
    <div class="row text-center">
        <div class="col-md-3 shadow rounded client inner p-0">
            <img src="{{URL::asset('/img/treshina-lobovogo-stekla.jpg')}}" alt="profile Pic" height="200" width="367">
            <div class="carousel-caption mx-auto"><h2>Ruitreparatie</h2></div>
        </div>
               
        <div class="col shadow rounded client ml-2 inner p-0">
            <img src="{{URL::asset('/img/onderhoud.jpg')}}" class="rounded" alt="profile Pic" height="200" width="367">
            <div class="carousel-caption"><h2>Onderhoud</h2></div>
        </div>
        <div class="col shadow rounded client ml-2 inner p-0">
                <img src="{{URL::asset('/img/Injectiesysteem Reinigen.jpg')}}" class="rounded" alt="profile Pic" height="200" width="367">
            <div class="carousel-caption"><h2>Brandstofsysteem Reinigen</h2></div>
        </div>
        <div class="col-md-3 shadow rounded client ml-2 inner p-0">
            <img src="{{URL::asset('/img/Koplampen polijsten 3.jpg')}}" class="rounded" alt="profile Pic" height="200" width="367">
